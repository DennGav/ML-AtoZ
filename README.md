...
## Credits
A huge thank you goes out to Kirill Eremenko, Hadelin de Ponteves, and the SuperDataScience team for creating such a great course that provides a well rounded dive into learning a plethora of different machine learning algorithms and use cases. I could not recommend this course enough, and would highly suggest anyone interesting in either data science, or machine learning, or both to register for this course.

### Promotion
I have also been lucky enough to provide all of you who are interested in also taking this course with a 50% off discount coupon! Please follow this link [here](https://www.udemy.com/machinelearning/?couponCode=ML50OFF) to register for the course with the mentioned discount
